...
#define _nstates1	23	/* fork */
#define minseq1	28
#define maxseq1	49
#define _endstate1	22

#define _nstates0	29	/* phil */
#define minseq0	0
#define maxseq0	27
...
#define Air2	(sizeof(P2) - Offsetof(P2, c5) - 1*sizeof(uchar))

#define Pfork	((P1 *)_this)
typedef struct P1 { /* fork */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, rp) - 1*sizeof(uchar))
...
#define Air0	(sizeof(P0) - Offsetof(P0, philno) - 1*sizeof(int))
